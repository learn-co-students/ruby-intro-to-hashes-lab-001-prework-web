...
#Create a hash named actor whose key is a symbol :name and whose value
# is a string, 'Dwayne The Rock Johnson'
def actor
	{name: "Dwayne The Rock Johnson"}
end

#Create an empty hash named monopoly, add a specific key-value pair to it,
# and return the hash
def monopoly
	monopoly = {}
	monopoly[:railroads] = {}
...
#Create and return monopoly hash with another nested layer added
